...
class move_can_pot(Base_Task):
    ...
    def load_actors(self):
        ...
        while (
            abs(rand_pos.p[0]) < 0.2
            or (pot_pose.p[0] - rand_pos.p[0]) ** 2
            + (pot_pose.p[1] - rand_pos.p[1]) ** 2
            < 0.09
        ):
            rand_pos = rand_pose(
                xlim=[-0.3, 0.3],
    ...
    def check_success(self):
        ...
        dis = (
            pot_pose[0] - can_pose[0]
            if self.arm_tag == "left"
            else can_pose[0] - pot_pose[0]
        )
        ...
        return (
            ...
            and check
            and (can_pose[2] <= self.orig_z + 0.001)
